...
FORCE_UNIQUE_POINTS = False  # False: descarta duplicados | True: tenta re-snap para ponto único
            ...
            if G_traj is not None:
                ...
                for i, point in enumerate(trajectory_points_priv):
                    ...
                    if not FORCE_UNIQUE_POINTS:
                        debug_map_print("      ==> Duplicado descartado (FORCE_UNIQUE_POINTS=False).")
                        discarded_points_vehicle += 1
                        continue
                    ...
                    if not found_unique_point:
                        debug_map_print(f"      ==> AVISO: Limite de tentativas ({MAX_MAP_MATCHING_ATTEMPTS}) excedido no índice {i}. Descartando ponto duplicado.")
                        discarded_points_vehicle += 1
                        continue
