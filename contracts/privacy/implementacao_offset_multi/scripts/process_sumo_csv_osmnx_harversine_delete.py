            ...
            if G_traj is not None:
                ...
                for i, point in enumerate(trajectory_points_priv):
                    ...
                    if not FORCE_UNIQUE_POINTS:
                        print("      ==> Duplicado descartado (FORCE_UNIQUE_POINTS=False).")
                    ...
                    if not found_unique_point:
                        print(f"      ==> AVISO: Limite de tentativas ({MAX_MAP_MATCHING_ATTEMPTS}) excedido no índice {i}. Descartando ponto duplicado.")
                        discarded_points_vehicle += 1
                        continue
